//
//  AchievementsFireworksView.swift
//  shader.trial.2
//
...
struct AchievementsFireworksView: View {
                    ...
                    VStack(spacing: 30) {
                        ...
                        LazyVGrid(columns: columns, spacing: 30) {
                            ForEach(achievements, id: \.id) { achievement in
                                AchievementBadgeFireworks(achievement: achievement) {
...
struct AchievementBadgeFireworks: View {
